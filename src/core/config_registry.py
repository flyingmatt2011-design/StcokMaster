...
SCHEMA_VERSION = "2026-09-01-kronos-forecast"
...
_FIELD_DEFINITIONS: Dict[str, Dict[str, Any]] = {
    ...
    "LITELLM_ANALYSIS_TIMEOUT_SECONDS": {
        "title": "LiteLLM Analysis Timeout Seconds",
        "description": "Default per-model timeout for analysis models. Slow models fail over after this budget instead of blocking the whole batch.",
        "category": "ai_model", "data_type": "integer", "ui_control": "number",
        "is_sensitive": False, "is_required": False, "is_editable": True,
        "default_value": "90", "options": [], "validation": {"min": 15, "max": 600},
        "display_order": 1, "help_key": "settings.ai_model.LITELLM_ANALYSIS_TIMEOUT_SECONDS", "examples": ["LITELLM_ANALYSIS_TIMEOUT_SECONDS=90"], "docs": [{"label": "分析流程与性能", "href": "https://github.com/flyingmatt2011-design/StcokMaster/blob/main/docs/stock-analysis-workflow.md"}], "warning_codes": [],
    },
    "LITELLM_FAST_MODEL_TIMEOUT_SECONDS": {
        "title": "LiteLLM Fast Model Timeout Seconds",
        "description": "Per-model timeout for model names containing flash.",
        "category": "ai_model", "data_type": "integer", "ui_control": "number",
        "is_sensitive": False, "is_required": False, "is_editable": True,
        "default_value": "60", "options": [], "validation": {"min": 15, "max": 600},
        "display_order": 1, "help_key": "settings.ai_model.LITELLM_FAST_MODEL_TIMEOUT_SECONDS", "examples": ["LITELLM_FAST_MODEL_TIMEOUT_SECONDS=60"], "docs": [{"label": "分析流程与性能", "href": "https://github.com/flyingmatt2011-design/StcokMaster/blob/main/docs/stock-analysis-workflow.md"}], "warning_codes": [],
    },
    "LITELLM_QUALITY_FALLBACK_TIMEOUT_SECONDS": {
        "title": "LiteLLM Quality Fallback Timeout Seconds",
        "description": "Per-model timeout for Claude/Sonnet quality fallback models.",
        "category": "ai_model", "data_type": "integer", "ui_control": "number",
        "is_sensitive": False, "is_required": False, "is_editable": True,
        "default_value": "120", "options": [], "validation": {"min": 15, "max": 600},
        "display_order": 1, "help_key": "settings.ai_model.LITELLM_QUALITY_FALLBACK_TIMEOUT_SECONDS", "examples": ["LITELLM_QUALITY_FALLBACK_TIMEOUT_SECONDS=120"], "docs": [{"label": "分析流程与性能", "href": "https://github.com/flyingmatt2011-design/StcokMaster/blob/main/docs/stock-analysis-workflow.md"}], "warning_codes": [],
    },
    "LITELLM_CIRCUIT_FAILURE_THRESHOLD": {
        "title": "LiteLLM Circuit Failure Threshold",
        "description": "Consecutive failures before one model route is temporarily skipped.",
        "category": "ai_model", "data_type": "integer", "ui_control": "number",
        "is_sensitive": False, "is_required": False, "is_editable": True,
        "default_value": "2", "options": [], "validation": {"min": 1, "max": 10},
        "display_order": 1, "help_key": "settings.ai_model.LITELLM_CIRCUIT_FAILURE_THRESHOLD", "examples": ["LITELLM_CIRCUIT_FAILURE_THRESHOLD=2"], "docs": [{"label": "分析流程与性能", "href": "https://github.com/flyingmatt2011-design/StcokMaster/blob/main/docs/stock-analysis-workflow.md"}], "warning_codes": [],
    },
    "LITELLM_CIRCUIT_COOLDOWN_SECONDS": {
        "title": "LiteLLM Circuit Cooldown Seconds",
        "description": "Cooldown before a failing model route is probed again.",
        "category": "ai_model", "data_type": "integer", "ui_control": "number",
        "is_sensitive": False, "is_required": False, "is_editable": True,
        "default_value": "180", "options": [], "validation": {"min": 15, "max": 3600},
        "display_order": 1, "help_key": "settings.ai_model.LITELLM_CIRCUIT_COOLDOWN_SECONDS", "examples": ["LITELLM_CIRCUIT_COOLDOWN_SECONDS=180"], "docs": [{"label": "分析流程与性能", "href": "https://github.com/flyingmatt2011-design/StcokMaster/blob/main/docs/stock-analysis-workflow.md"}], "warning_codes": [],
    },
    ...
    "KRONOS_ENABLED": {
        "title": "Kronos Forecast Enabled",
        "description": "Generate an experimental Kronos forecast after the StockMaster decision is finalized.",
        "category": "forecast",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
        ...
        "validation": {},
        "display_order": 10,
        "help_key": "settings.forecast.kronos",
        "examples": ["KRONOS_ENABLED=true", "KRONOS_ENABLED=false"],
        "docs": [
            {
                "label": "Kronos 预测说明",
                "href": "https://github.com/flyingmatt2011-design/StcokMaster/blob/main/docs/kronos-forecast.md",
            },
        ],
        "warning_codes": [],
    },
    "KRONOS_MODEL": {
        "title": "Kronos Model",
        "description": "Hugging Face model ID used by the optional Kronos predictor.",
        "category": "forecast",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
        "is_required": False,
        "is_editable": True,
        "default_value": "NeoQuasar/Kronos-small",
        "options": [],
        "validation": {},
        "display_order": 20,
        "help_key": "settings.forecast.kronos",
        "examples": ["KRONOS_MODEL=NeoQuasar/Kronos-small"],
        "docs": [
            {
                "label": "Kronos 预测说明",
                "href": "https://github.com/flyingmatt2011-design/StcokMaster/blob/main/docs/kronos-forecast.md",
    ...
    "KRONOS_TOKENIZER": {
        "title": "Kronos Tokenizer",
        "description": "Hugging Face tokenizer ID paired with the Kronos model.",
        "category": "forecast",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
        "is_required": False,
        "is_editable": True,
        "default_value": "NeoQuasar/Kronos-Tokenizer-base",
        "options": [],
        "validation": {},
        "display_order": 30,
        "help_key": "settings.forecast.kronos",
        "examples": ["KRONOS_TOKENIZER=NeoQuasar/Kronos-Tokenizer-base"],
        "docs": [
            {
                "label": "Kronos 预测说明",
                "href": "https://github.com/flyingmatt2011-design/StcokMaster/blob/main/docs/kronos-forecast.md",
    ...
    "KRONOS_LOOKBACK": {
        "title": "Kronos Lookback",
        "description": "Number of completed daily bars supplied to Kronos.",
        "category": "forecast",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
        ...
        "default_value": "400",
        "options": [],
        "validation": {"min": 120, "max": 512},
        "display_order": 40,
        "help_key": "settings.forecast.kronos",
        "examples": ["KRONOS_LOOKBACK=400"],
        "docs": [
            {
                "label": "Kronos 预测说明",
                "href": "https://github.com/flyingmatt2011-design/StcokMaster/blob/main/docs/kronos-forecast.md",
    ...
    "KRONOS_PRED_LEN": {
        "title": "Kronos Prediction Sessions",
        "description": "Number of future A-share trading sessions to forecast.",
        "category": "forecast",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "KRONOS_SAMPLE_COUNT": {
        "title": "Kronos Sample Count",
        "description": "Sampling paths averaged by Kronos during inference.",
        "category": "forecast",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
        ...
        "display_order": 60,
        "help_key": "settings.forecast.kronos",
        "examples": ["KRONOS_SAMPLE_COUNT=5"],
        "docs": [
            {
                "label": "Kronos 预测说明",
                "href": "https://github.com/flyingmatt2011-design/StcokMaster/blob/main/docs/kronos-forecast.md",
    ...
    "KRONOS_DEVICE": {
        "title": "Kronos Device",
        "description": "Inference device; auto selects CUDA, MPS, or CPU.",
        "category": "forecast",
        "data_type": "string",
        "ui_control": "select",
        "is_sensitive": False,
        ...
        "validation": {"enum": ["auto", "cpu", "cuda:0"]},
        "display_order": 70,
        "help_key": "settings.forecast.kronos",
        "examples": ["KRONOS_DEVICE=auto"],
        "docs": [
            {
                "label": "Kronos 预测说明",
                "href": "https://github.com/flyingmatt2011-design/StcokMaster/blob/main/docs/kronos-forecast.md",
    ...
    "KRONOS_NEUTRAL_BAND_PCT": {
        "title": "Kronos Neutral Band Pct",
        "description": "Display-only neutral direction band around zero return.",
        "category": "forecast",
        "data_type": "number",
        "ui_control": "number",
        "is_sensitive": False,
        ...
        "default_value": "1.0",
        "options": [],
        "validation": {"min": 0.0, "max": 20.0},
        "display_order": 80,
        "help_key": "settings.forecast.kronos",
        "examples": ["KRONOS_NEUTRAL_BAND_PCT=1.0"],
        "docs": [
            {
                "label": "Kronos 预测说明",
                "href": "https://github.com/flyingmatt2011-design/StcokMaster/blob/main/docs/kronos-forecast.md",
