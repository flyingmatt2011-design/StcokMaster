...
class SystemConfigService:
    ...
    _GENERATION_BACKEND_STATUS_EXACT_KEYS = {
        ...
        "LITELLM_ANALYSIS_TIMEOUT_SECONDS",
        "LITELLM_FAST_MODEL_TIMEOUT_SECONDS",
        "LITELLM_QUALITY_FALLBACK_TIMEOUT_SECONDS",
        "LITELLM_CIRCUIT_FAILURE_THRESHOLD",
        "LITELLM_CIRCUIT_COOLDOWN_SECONDS",
